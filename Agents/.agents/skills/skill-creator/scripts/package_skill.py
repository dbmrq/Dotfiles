...
def validate_skill(skill_path):
    """
    Validate a skill folder meets all requirements.
    ...
    if not end_match:
        return False, "SKILL.md frontmatter not properly closed with ---"
    ...
    # Extract name and validate it matches directory
    ...
    if name_match:
        ...
        if not re.match(r'^[a-z0-9][a-z0-9-]*[a-z0-9]$|^[a-z0-9]$', skill_name):
            return False, f"Skill name '{skill_name}' must be lowercase alphanumeric with hyphens, not starting/ending with hyphen"
